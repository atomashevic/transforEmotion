...
\FunctionTok{transformer\_scores}\NormalTok{(}
    \AttributeTok{text =}\NormalTok{ neo\_ipip\_extraversion}\SpecialCharTok{$}\NormalTok{friendliness[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{], }\CommentTok{\# positively worded items only}
...
\NormalTok{  friendly gregarious  assertive     active excitement   cheerful }
     \FloatTok{0.297}      \FloatTok{0.518}      \FloatTok{0.031}      \FloatTok{0.113}      \FloatTok{0.007}      \FloatTok{0.034} 

\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Warm up quickly to others}\StringTok{\textasciigrave{}}
\NormalTok{  friendly gregarious  assertive     active excitement   cheerful }
     \FloatTok{0.457}      \FloatTok{0.196}      \FloatTok{0.044}      \FloatTok{0.206}      \FloatTok{0.033}      \FloatTok{0.064} 

\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Feel comfortable around people}\StringTok{\textasciigrave{}}
\NormalTok{  friendly gregarious  assertive     active excitement   cheerful }
     \FloatTok{0.244}      \FloatTok{0.465}      \FloatTok{0.027}      \FloatTok{0.206}      \FloatTok{0.015}      \FloatTok{0.042} 

\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Act comfortably around people}\StringTok{\textasciigrave{}}
\NormalTok{  friendly gregarious  assertive     active excitement   cheerful }
     \FloatTok{0.269}      \FloatTok{0.359}      \FloatTok{0.037}      \FloatTok{0.303}      \FloatTok{0.003}      \FloatTok{0.029} 

\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Cheer people up}\StringTok{\textasciigrave{}}
\NormalTok{  friendly gregarious  assertive     active excitement   cheerful }
     \FloatTok{0.302}      \FloatTok{0.176}      \FloatTok{0.035}      \FloatTok{0.060}      \FloatTok{0.090}      \FloatTok{0.335} 
\end{Highlighting}
\end{Shaded}
...
\texttt{transformer\_scores} function is called in a new R session. For
repeated usage, the \texttt{keep\_in\_env} argument should be set to
\texttt{TRUE} (which is the default) to keep the classifier loaded in
the environment.
