...
$`Make friends easily`
  friendly gregarious  assertive     active excitement   cheerful 
     0.530      0.088      0.094      0.088      0.069      0.132 

$`Warm up quickly to others`
  friendly gregarious  assertive     active excitement   cheerful 
     0.057      0.032      0.176      0.177      0.305      0.252 

$`Feel comfortable around people`
  friendly gregarious  assertive     active excitement   cheerful 
     0.735      0.033      0.050      0.047      0.020      0.116 

$`Act comfortably around people`
  friendly gregarious  assertive     active excitement   cheerful 
     0.441      0.049      0.141      0.230      0.027      0.112 

$`Cheer people up`
  friendly gregarious  assertive     active excitement   cheerful 
     0.083      0.135      0.108      0.074      0.332      0.268
```
