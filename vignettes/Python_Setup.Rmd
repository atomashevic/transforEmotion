...
<!-- Silent load Python -->
```{r python_setup_true, eval = TRUE, echo = FALSE, comment = NA, warning = FALSE, message = FALSE}
python_setup("D:/Python/python.exe")
```
...
```{r python_setup, eval = FALSE, echo = TRUE, comment = NA, warning = FALSE, message = FALSE}
python_setup()
```
