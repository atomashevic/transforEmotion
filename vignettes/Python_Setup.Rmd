...
```{r python_install, eval = TRUE, echo = TRUE, comment = NA, warning = FALSE, message = FALSE}
...
```{r python_location, eval = TRUE, echo = TRUE, comment = NA, warning = FALSE, message = FALSE}
...
```{r transformers_install, eval = TRUE, echo = TRUE, comment = NA, warning = FALSE, message = FALSE}
